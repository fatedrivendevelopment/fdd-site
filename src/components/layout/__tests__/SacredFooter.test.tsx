  ...
  describe("Given a SacredFooter component", () => {
    describe("When rendered with default props", () => {
      ...
      test("Then it should display mystical branding", () => {
        ...
        expect(
          screen.getByRole("img", { name: /crystal ball/i }),
        ).toBeInTheDocument();
      });
      ...
      test("Then it should display description text", () => {
        ...
        expect(
          screen.getByText(/satirical software methodology/i),
        ).toBeInTheDocument();
    ...
    describe("When displaying navigation links", () => {
      ...
      test("Then it should contain external links with proper attributes", () => {
        ...
        expect(githubLink).toHaveAttribute(
          "href",
          "https://github.com/fatedrivendevelopment",
        );
      ...
      test("Then it should contain internal navigation links", () => {
        ...
        expect(
          screen.getByRole("link", { name: /sacred principles/i }),
        ).toBeInTheDocument();
        expect(
          screen.getByRole("link", { name: /cosmic q&a/i }),
        ).toBeInTheDocument();
      });
    });
    ...
    describe("When displaying footer content", () => {
      test("Then it should show copyright notice", () => {
        ...
        expect(
          screen.getAllByText(/Fate-Driven Development/).length,
        ).toBeGreaterThan(0);
      });
      ...
      test("Then it should show mystical disclaimer", () => {
        ...
        expect(
          screen.getByText(
            /This page was rendered under the influence of Mercury retrograde/i,
          ),
        ).toBeInTheDocument();
        expect(
          screen.getByText(/No actual mystical forces were harmed/i),
        ).toBeInTheDocument();
      });
