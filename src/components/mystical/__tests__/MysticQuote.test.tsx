...
describe("MysticQuote Component", () => {
  ...
  describe("Given a MysticQuote component", () => {
    describe("When rendered with default props", () => {
      test("Then it should display mystical wisdom and refresh functionality", async () => {
        ...
        await waitFor(() => {
          expect(
            screen.getByText(/The cosmic forces align in mysterious ways/),
          ).toBeInTheDocument();
        });
    ...
    describe("When provided with specific wisdom", () => {
      test("Then it should display the provided wisdom", async () => {
        ...
        render(<MysticQuote wisdom={providedWisdom} />);
        ...
        await waitFor(() => {
          expect(
            screen.getByText(new RegExp(providedWisdom)),
          ).toBeInTheDocument();
        });
      });
    });
    ...
    describe("When provided with context", () => {
      test("Then it should generate contextual wisdom", async () => {
        ...
        render(<MysticQuote context={context} />);
        ...
        await waitFor(() => {
          expect(mockWisdomEngine.contextualWisdom).toHaveBeenCalledWith(
            context,
          );
        });
        ...
        expect(
          screen.getByText(
            /Context-specific mystical wisdom flows through the universe/,
          ),
        ).toBeInTheDocument();
      });
    });
    ...
    describe("When refresh button is clicked", () => {
      test("Then it should channel new wisdom", async () => {
        ...
        render(
          <MysticQuote showRefresh={true} data-testid="mystic-quote-refresh" />,
        );
        ...
        await waitFor(() => {
          expect(
            screen.getByText(/New cosmic wisdom emerges from the void/),
          ).toBeInTheDocument();
        });
      });
    });
  ...
  describe("Accessibility", () => {
    test("Then it should have proper ARIA attributes", async () => {
      ...
      const quote = screen
        .getByText(/The cosmic forces align in mysterious ways/)
        .closest("blockquote");
