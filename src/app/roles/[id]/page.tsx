      ...
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-cosmic-silver/70 mb-8">
            This mystical role has not yet been channeled into our cosmic database.
          </p>
          <Link
            href="/roles"
        ...
        <div className="container mx-auto max-w-4xl">
          ...
          <div className="flex flex-wrap justify-center gap-6 mb-8">
            <div className="bg-cosmic-dark/30 backdrop-blur border border-cosmic-silver/20 rounded-xl px-6 py-3">
              <div className="text-sm text-cosmic-silver/70 mb-1">Aura Color</div>
              <div className={`text-aura-${role.aura} font-semibold capitalize`}>{role.aura}</div>
            </div>
            <div className="bg-cosmic-dark/30 backdrop-blur border border-cosmic-silver/20 rounded-xl px-6 py-3">
              <div className="text-sm text-cosmic-silver/70 mb-1">Cosmic Level</div>
              <div className="text-cosmic-gold font-semibold capitalize">{role.cosmicLevel}</div>
            </div>
                         <div className="bg-cosmic-dark/30 backdrop-blur border border-cosmic-silver/20 rounded-xl px-6 py-3">
               <div className="text-sm text-cosmic-silver/70 mb-1">Current Energy</div>
               <div className="text-aura-blue font-semibold capitalize">{currentCosmicEnergy}</div>
             </div>
            <div className="bg-cosmic-dark/30 backdrop-blur border border-cosmic-silver/20 rounded-xl px-6 py-3">
              <div className="text-sm text-cosmic-silver/70 mb-1">Moon Phase</div>
              <div className="text-cosmic-silver font-semibold">{moonPhase}</div>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto max-w-6xl">
              ...
              <div className="space-y-4">
                {role.responsibilities.map((responsibility: string, index: number) => (
                  <div key={index} className="flex items-start space-x-3">
                    <div className={`w-6 h-6 rounded-full bg-gradient-to-br from-aura-${role.aura}/20 to-aura-${role.aura}/40 border border-aura-${role.aura}/30 flex items-center justify-center flex-shrink-0 mt-1`}>
                      <span className="text-xs font-bold text-cosmic-silver">{index + 1}</span>
                    </div>
              ...
              <div className="space-y-4">
                {role.mysticalTools.map((tool: string, index: number) => (
                  <div key={index} className="flex items-center space-x-3 group">
                    <div className={`w-3 h-3 rounded-full bg-gradient-to-r from-aura-${role.aura} to-aura-violet opacity-70 group-hover:opacity-100 transition-opacity`}></div>
          ...
          <div className="mt-16 bg-cosmic-dark/30 backdrop-blur border border-cosmic-silver/20 rounded-xl p-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="text-center">
                <div className={`w-16 h-16 mx-auto mb-3 rounded-full bg-gradient-to-br from-aura-${role.aura}/20 to-aura-${role.aura}/40 border-2 border-aura-${role.aura}/50 flex items-center justify-center`}>
                  <span className="text-2xl">🌟</span>
                </div>
                <h3 className="font-semibold text-cosmic-silver mb-2">Primary Frequency</h3>
                <p className="text-cosmic-silver/70 text-sm">Resonates with {role.aura} aura energies and cosmic {role.cosmicLevel} vibrations</p>
              </div>
              ...
              <div className="text-center">
                ...
                <h3 className="font-semibold text-cosmic-silver mb-2">Cosmic Alignment</h3>
                <p className="text-cosmic-silver/70 text-sm">Perfectly aligned with universal development forces and sacred coding practices</p>
              </div>
              ...
              <div className="text-center">
                ...
                <h3 className="font-semibold text-cosmic-silver mb-2">Mystical Potential</h3>
                <p className="text-cosmic-silver/70 text-sm">Channels infinite potential through focused spiritual practice and cosmic awareness</p>
              </div>
            </div>
          </div>
        </div>
