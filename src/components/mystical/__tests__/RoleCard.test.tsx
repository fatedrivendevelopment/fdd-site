...
jest.mock('@/lib/cosmic-utils', () => ({
  ...
  wisdomEngine: {
    ...
    channelWisdom: jest.fn().mockReturnValue('Test wisdom from the cosmic realm')
  },
  ...
  describe('Given a RoleCard component', () => {
    describe('When rendered with role data', () => {
      test('Then it should display role information correctly', () => {
        ...
        expect(screen.getByText('Tests the cosmic energies')).toBeInTheDocument();
      ...
      test('Then it should display mystical decorations', () => {
        ...
        expect(screen.getByText(/Mocked cosmic wisdom for testing purposes/)).toBeInTheDocument(); // Wisdom text with partial match
    ...
    describe('When role has different cosmic levels', () => {
      test('Then it should display transcendent level correctly', () => {
        ...
        const transcendentRole = { ...mockRole, cosmicLevel: 'transcendent' as const };
        render(<RoleCard role={transcendentRole} />);

        // When: Component loads
        // Then: Should show transcendent level
        expect(screen.getByText(/Cosmic Level.*transcendent/)).toBeInTheDocument();
      });
