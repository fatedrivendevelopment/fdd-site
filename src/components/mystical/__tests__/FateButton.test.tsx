  ...
  describe("Given a FateButton component", () => {
    ...
    describe("When Mercury is in retrograde", () => {
      test("Then it should show warning indicator with low cosmic energy", () => {
        ...
        render(
          <FateButton cosmicEnergy="low" data-testid="fate-button-retrograde">
            Challenged Energy
          </FateButton>,
        );
        ...
        expect(button).toHaveAttribute(
          "title",
          expect.stringContaining("Mercury retrograde detected"),
        );
    ...
    describe("When using different sizes", () => {
      test("Then it should apply appropriate sizing classes", () => {
        ...
        sizes.forEach((size) => {
          const { unmount } = render(
            <FateButton size={size} data-testid={`fate-button-${size}`}>
              {size} Button
            </FateButton>,
          );
