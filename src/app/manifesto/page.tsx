      ...
      <section className="relative py-16 px-4 overflow-hidden">
        ...
        <div className="container mx-auto max-w-4xl relative z-10 text-center">
          ...
          <h1 className="text-5xl md:text-7xl font-bold mb-6">
            <span
              className="bg-gradient-to-r from-cosmic-gold via-aura-orange to-aura-red bg-clip-text text-cosmic-gold"
              style={{
          ...
          <p className="text-xl text-cosmic-silver/90 mb-8 max-w-3xl mx-auto leading-relaxed">
            The sacred principles that transform mundane development into
            mystical creation.
          </p>
          ...
          <div className="flex items-center justify-center space-x-6 text-sm text-cosmic-silver/70">
            ...
            <div className="flex items-center space-x-2">
              <span>🔮</span>
              <span>
                Mystical Level: {manifestoContent.metadata.mysticalLevel}
              </span>
            </div>
            <div className="flex items-center space-x-2">
              <span>✨</span>
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-12">
            ...
            <p className="text-cosmic-silver/70 max-w-2xl mx-auto">
              We, the developers attuned to destiny, guided by intuition, commit
              ourselves to the sacred path:
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
            {[
              ...
              },
              {
                ...
                description:
                  "Clients may not know what they want. But the stars do. Feedback comes from fate, not forms.",
                icon: "🔮",
              },
              {
            ...
            {[
              {
                ...
                description:
                  "Plans are fragile. Prophecies endure. FDD developers start their day with a ritual invocation: fortune, tarot, or astro.sh.",
                icon: "🌌",
              },
              {
                title: "Spiritual Resonance > Team Communication",
                description:
                  'Slack is noise. Silence speaks. Weekly "Code in Silence" sessions foster psychic sync. If the vibe aligns, no backlog is needed.',
                icon: "🧘‍♀️",
              },
              {
                title: "Rituals > Procedures",
                description:
                  "Every task has a sacred mirror. No code review — only purification rites. Merges are preceded by candle-lit dice rolls.",
                icon: "🕯️",
              },
              {
                title: "Surrender > Control",
                description:
                  "Micromanagement disrupts karma. The Fate Master guides gently. Code is written by destiny — the developer is merely the vessel.",
                icon: "🙏",
              },
            ].map((value, index) => (
              <div
          ...
          <div className="bg-gradient-to-r from-cosmic-silver/5 to-cosmic-gold/5 rounded-2xl p-8 border border-cosmic-silver/20 mb-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {[
                {
                  num: 1,
                  text: "Code must be felt before it is written",
                  icon: "🧘‍♀️",
                },
                {
                  num: 2,
                  text: "Features are prioritized by Tarot",
                  icon: "🔮",
                },
                {
                  num: 3,
                  text: "No deploy is rushed — Saturn must approve",
                  icon: "🪐",
                },
                {
                  num: 4,
                  text: "Meetings are replaced by rituals",
                  icon: "🕯️",
                },
                {
                  num: 5,
                  text: "If code has a soul, ignore the syntax error",
                  icon: "👻",
                },
                {
                  num: 6,
                  text: "Tests are conducted via ocular aura analysis",
                  icon: "👁️",
                },
                {
                  num: 7,
                  text: "The goal is karmic balance, not profit",
                  icon: "⚖️",
                },
                {
                  num: 8,
                  text: "Newcomers undergo spiritual reincarnation, not onboarding",
                  icon: "🦋",
                },
                {
                  num: 9,
                  text: "Versions are named after celestial alignments",
                  icon: "⭐",
                },
                {
                  num: 10,
                  text: "Retrospectives become introspectives",
                  icon: "🪞",
                },
                {
                  num: 11,
                  text: "Docs are written as prophecy, not prose",
                  icon: "📜",
                },
                {
                  num: 12,
                  text: "A release is complete only when the soul is cleansed",
                  icon: "✨",
                },
              ].map((principle) => (
                <div
          ...
          <div className="bg-gradient-to-r from-aura-purple/10 via-cosmic-silver/5 to-aura-blue/10 rounded-2xl p-8 border border-cosmic-silver/20 mb-12">
            ...
            <blockquote className="text-lg text-cosmic-silver/90 leading-relaxed text-center">
              <p className="mb-6 italic">
                &ldquo;I walk the path destiny draws,
                <br />
              ...
              <div className="text-center">
                <span className="text-2xl font-bold text-aura-purple">
                  I so swear.
                </span>
              </div>
            </blockquote>
            ...
            {[
              {
                ...
                icon: "🔮",
                description:
                  "Discover your mystical role in the cosmic development circle",
              },
              {
                ...
                icon: "🕯️",
                description:
                  "Learn the ceremonies that align your development practice",
              },
              {
                ...
                icon: "🌌",
                description:
                  "Understand the eternal flow of fate-driven development",
              },
            ].map((link) => (
              <a
                key={link.href}
